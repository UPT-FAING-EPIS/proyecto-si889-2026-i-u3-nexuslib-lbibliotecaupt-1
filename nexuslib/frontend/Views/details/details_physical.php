...
<script>
// Copy APA citation button logic (physical)
(function(){
    ...
    function choosePublisher(editorial, origen){ editorial = (editorial||'').trim(); origen = (origen||'').trim(); if(editorial) return editorial; if(/Inventario UPT|Biblioteca UPT/i.test(origen)) return 'Universidad Privada de Tacna'; return origen || 'Universidad Privada de Tacna'; }
    ...
    btn.addEventListener('click', async function(){
        ...
        const yearRaw = extractText('det-ano-publicacion');
        ...
        try{
            ...
            const oldHTML = btn.innerHTML; const oldClasses = btn.className;
